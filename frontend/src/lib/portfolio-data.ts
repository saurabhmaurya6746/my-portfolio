...
export const projects: Project[] = [
  {
    title: "NextVisit CRM",
    description:
      "A full-stack CRM platform for salons and restaurants with bookings, customer management, loyalty, payments, automation and QR-based ordering.",
    longDescription:
...
export const certificates = [
  ...
  { title: "Star Performer Award During Internship", image: star },
