    ...
    >
      <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr]">
        ...
        <motion.button
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="group relative overflow-hidden rounded-3xl glass p-3 text-left transition-all hover:scale-[1.01] cursor-pointer"
        >
          <img
            src={internship}
      ...
      <ImageLightboxModal
        ...
        title="Softpro Internship Certificate"
        image={internship}
      />
    </Section>
  );
